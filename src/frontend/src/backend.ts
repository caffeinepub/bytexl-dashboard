...
export class Backend implements backendInterface {
    ...
    async addJobRole(arg0: JobRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addJobRole(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getConsultations(): Promise<Array<ConsultationRequest>> {
        if (this.processError) {
            try {
    ...
    async getProjects(): Promise<Array<ProjectIdea>> {
        if (this.processError) {
            try {
    ...
    async submitAnalysis(arg0: AnalysisResult): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAnalysis(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitProject(arg0: ProjectIdea): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitProject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
